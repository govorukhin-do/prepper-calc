                  ...
                  <form className="space-y-4" onSubmit={async (e) => {
                    ...
                    if (type === 'order') {
                      ...
                      if (typeof window !== 'undefined' && (window as any).onSubminMainForm) {
                        await (window as any).onSubminMainForm(orderData).then(
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input name="phone" type="tel" required className="w-full bg-tactical-bg border border-tactical-border rounded-xl py-3 pl-10 pr-4 text-white focus:border-tactical-accent outline-none" placeholder="+7 (999) 000-00-00" />
                      </div>
                    </div>
                    <div className="space-y-2">
                ...
                >
                  ...
                  <form className="space-y-4" onSubmit={async (e) => {
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea required name="message"  className="w-full bg-tactical-bg border border-tactical-border rounded-xl py-3 px-4 text-white focus:border-tactical-accent outline-none min-h-[120px]" placeholder="Опишите ваше предложение..." />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-mono text-tactical-muted uppercase">Контакт для связи (опционально)</label>
                      <input type="text" name="contact"  className="w-full bg-tactical-bg border border-tactical-border rounded-xl py-3 px-4 text-white focus:border-tactical-accent outline-none" placeholder="Email или телефон" />
                    </div>
                    <button type="submit" className="w-full py-4 bg-tactical-accent text-tactical-bg rounded-xl font-black uppercase tracking-tighter mt-4 hover:scale-[1.02] transition-transform">
                      Отправить
                    </button>
